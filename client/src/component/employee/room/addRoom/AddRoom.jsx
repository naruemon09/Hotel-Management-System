...
const AddRoom = () => {
    ...
    const onSubmit = async () => {
      try {
        ...
        const response = await axios.post(`http://localhost:3000/room`, formData, { params: {val}});
      ...
      <div className='container-list'>
        ...
        <div className='row'>
          ...
          <div className='col-30'>
            <input className='input-x' name='room_no' type='text' value={room.room_no} onChange={(e) => setRoom({...room, room_no:e.target.value})}/>
          </div> 
        </div>
